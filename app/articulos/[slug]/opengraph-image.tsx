...
const ARTICLES: Record<string, { title: string; author: string; type: string }> = {
  ...
  "tesis-dano-moral-indirecto": { title: "El daño moral indirecto familiar y social como responsabilidad patrimonial de la Administración", author: "MSc. Katherine González Coto", type: "Tesis" },
  ...
  "tesis-procedimiento-expropiatorio-cr": { title: "Transformación y perspectivas del procedimiento expropiatorio en Costa Rica", author: "MSc. Katherine González Coto", type: "Tesis" },
