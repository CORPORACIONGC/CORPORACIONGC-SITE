...
export const AREA_COMMERCIAL: Record<string, CommercialLanding> = {
  ...
  "regulacion-fintech-criptoactivos": {
    ...
    services: [
      ...
      { title: "Inscripción VASP ante SUGEF bajo la Ley N.° 10961", description: "Emitimos el dictamen de sujeción al artículo 15 quater de la Ley N.° 7786, mapeamos qué actividad realiza cada entidad del grupo, resolvemos los tres cuellos de botella del trámite —representante con firma digital costarricense, cuenta bancaria exclusiva en una entidad supervisada y coherencia de la inscripción tributaria— y armamos el expediente para presentarlo el día en que SUGEF habilite la plataforma conforme al reglamento del CONASSIF." },
