...
export const AREA_COMMERCIAL: Record<string, CommercialLanding> = {
  ...
  "regulacion-fintech-criptoactivos": {
    hookHeadline: "¿Presta servicios con activos virtuales y necesita inscribirse ante SUGEF sin quedar fuera del sistema bancario?",
    hookSubtext:
    ...
    relatedArticleSlug: "registro-vasp-sugef-costa-rica",
    relatedArticleLabel: "Guía completa del registro VASP ante SUGEF bajo la Ley 10961",
