...
export const PRACTICE_AREA_PAGES = [
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogado en Contratación Pública en Costa Rica",
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogado en Derecho Administrativo en Costa Rica",
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogado en Procedimiento Sancionatorio en Costa Rica",
