...
export const PRACTICE_AREA_PAGES = [
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogados en Contratación Pública · Objeción, apelación y sanciones",
    seoDescription:
      "Objeción al cartel, apelación ante la Contraloría y defensa en sanciones e inhabilitaciones. Ley General de Contratación Pública 9986 y su reglamento.",
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogados en Derecho Público y Administrativo en Costa Rica",
    seoDescription:
      "¿Un acto de la Administración lo perjudica? Nulidad, revocatoria y apelación ante la institución, y litigio si no responde. Bufete dedicado al Derecho Público.",
    ogShortTitle: "Abogados en {{em}}",
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Abogados en Procedimiento Sancionatorio · Traslado de cargos",
    seoDescription:
      "Defensa de funcionarios, proveedores y empresas reguladas: traslado de cargos, comparecencia oral, recursos y caducidad del procedimiento (art. 340 LGAP).",
  ...
  },
  {
    ...
    priority: "specialized" as const,
    seoTitle: "Abogados en Derecho Municipal · Patentes, tributos y Concejo",
    seoDescription:
      "Patentes denegadas, cobros municipales y acuerdos del Concejo: los recursos del Código Municipal y el litigio ante el Tribunal Contencioso, Sección Tercera.",
    ogShortTitle: "Abogados en {{em}}",
  ...
  },
  {
    ...
    icon: "Waves" as const,
    priority: "specialized" as const,
    seoTitle: "Abogados en Zona Marítimo Terrestre · Ley 6043 y concesiones",
    seoDescription:
      "Concesiones en la ZMT, prórrogas, caducidades y demoliciones en la zona pública. Qué permite la Ley 6043 y cómo defender una concesión ante la municipalidad.",
  ...
  },
  {
    ...
    description: "Asesoría en proyectos de concesión e infraestructura pública bajo el régimen vigente de la Ley General de Concesión de Obras Públicas con Servicios Públicos (Ley N.° 7762, reformada por las leyes N.° 8643 y N.° 9701) y frente al proyecto del expediente N.° 24.009 (Ley Marco de las Asociaciones Público-Privadas, aprobado en primer debate el 18 de mayo de 2026; el 9 de setiembre de 2026 la Sala Constitucional declaró inconstitucional la agencia que crea y el proyecto volvió a la Asamblea). Estructuración de proyectos, refrendo de contratos, objeción de carteles y apelación de adjudicaciones ante la Contraloría, y litigio contencioso-administrativo contra los actos del CNC, MOPT y CGR que afecten el contrato.",
  ...
  },
  {
    ...
    icon: "MapPin" as const,
    priority: "primary" as const,
    seoTitle: "Abogado en expropiaciones en Costa Rica · Avalúo y justo precio",
    seoDescription:
      "¿Le notificaron una expropiación? Impugnamos el avalúo administrativo y reclamamos el justo precio, el lucro cesante y los intereses de la Ley 7495.",
