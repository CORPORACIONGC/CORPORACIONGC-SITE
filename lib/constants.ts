...
export const PRACTICE_AREA_PAGES = [
  ...
  },
  {
    ...
    icon: "Waves" as const,
    priority: "specialized" as const,
    seoTitle: "Zona Marítimo Terrestre Costa Rica 2026 · Ley 6043 ZMT",
    seoDescription: "¿Demolición o vence su concesión en zona marítimo terrestre? Abogados en Ley 6043: defensa de concesiones y litigio. Quepos, Tamarindo, Sámara y todo CR.",
  ...
  },
  {
    ...
    subtitle: "Concesiones de obra pública, arbitraje contractual y litigio ante CGR, MOPT y el Consejo Nacional de Concesiones",
    description: "Asesoría en proyectos de concesión e infraestructura pública bajo el régimen vigente de la Ley General de Concesión de Obras Públicas con Servicios Públicos (Ley N.° 7762, reformada por las leyes N.° 8643 y N.° 9701) y bajo el régimen entrante del expediente N.° 24.009 (Ley Marco de las Asociaciones Público-Privadas, aprobado en primer debate el 19 de mayo de 2026 y suspendido por consulta facultativa de constitucionalidad ante la Sala Constitucional). Estructuración de proyectos, refrendo de contratos, objeción de carteles y apelación de adjudicaciones ante la Contraloría, arbitraje contractual (art. 39 Ley 7762) y litigio contencioso-administrativo.",
    icon: "Factory" as const,
    priority: "specialized" as const,
    seoTitle: "Abogados en Concesiones y APP en Costa Rica",
    seoDescription: "Abogados en concesiones y APP en Costa Rica: estructuración, refrendo CGR, objeción de carteles, arbitraje (art. 39 Ley 7762) y litigio. Régimen vigente y nuevo expediente 24.009.",
    ogShortTitle: "Abogados en {{em}}",
