...
export const PRACTICE_AREA_PAGES = [
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Contratación Pública y Licitaciones Costa Rica 2026",
    seoDescription: "Objeción al cartel, impugnación de adjudicaciones y litigio en licitaciones ante la CGR y el TCA (Ley 9986). Abogados para contratistas en Costa Rica.",
  ...
  },
  {
    ...
    priority: "primary" as const,
    seoTitle: "Defensa en Procedimientos Sancionatorios Costa Rica 2026",
    seoDescription: "¿Le abrieron un procedimiento sancionatorio? Defensa del administrado: debido proceso, audiencia oral y recursos ante la Administración. Asesoría urgente.",
