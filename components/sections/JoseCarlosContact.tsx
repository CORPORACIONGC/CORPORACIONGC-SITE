...
const contactItems = [
  {
    icon: Envelope,
    label: "Email",
    value: JOSE_CARLOS_CONTACT.email,
    href: `mailto:${JOSE_CARLOS_CONTACT.email}`,
  },
  {
    icon: Phone,
    label: "Teléfono",
    value: JOSE_CARLOS_CONTACT.phone,
    href: `tel:${JOSE_CARLOS_CONTACT.phoneRaw}`,
  },
];

export function JoseCarlosContact() {
  return (
          ...
          <div>
            ...
            <AnimatedEntry delay={0.2}>
              <p className="mt-5 text-sm text-cream/55 leading-relaxed max-w-[50ch]">
                Atiendo consultas jurídicas en Derecho Público, Derecho
                Constitucional, litigio contencioso-administrativo, Derecho
                Tributario y servicios notariales. Cuénteme su situación y
