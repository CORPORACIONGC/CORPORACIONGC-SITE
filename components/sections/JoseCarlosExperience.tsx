...
import { JOSE_CARLOS_PROFILE } from "@/lib/constants";
import { AnimatedEntry, StaggerContainer, StaggerItem } from "@/components/ui/AnimatedEntry";

export function JoseCarlosExperience() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.4fr_1fr] gap-12 lg:gap-20">
          ...
          <div>
            ...
            <AnimatedEntry delay={0.2}>
              <p className="mt-5 text-sm text-cream/50 leading-relaxed max-w-[35ch]">
                Desde la asistencia legal hasta el litigio de alta complejidad,
                una trayectoria forjada con disciplina académica y práctica
                jurídica rigurosa.
              </p>
            </AnimatedEntry>
          </div>
          ...
          <StaggerContainer className="relative" stagger={0.1}>
            ...
            <div className="space-y-1">
              {JOSE_CARLOS_PROFILE.career.map((exp, i) => (
                <StaggerItem key={i}>
                  <div
            ...
            <StaggerItem>
              <div className="relative pl-10 mt-8 pt-6 border-t border-cream/[0.08]">
                ...
                <h3 className="text-sm font-semibold text-cream/90 tracking-tight max-w-[55ch]">
                  {JOSE_CARLOS_PROFILE.research.title}
                </h3>
                <p className="mt-2 text-xs text-cream/50 leading-relaxed max-w-[55ch]">
                  {JOSE_CARLOS_PROFILE.research.description}
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {JOSE_CARLOS_PROFILE.research.tags.map((tag, i) => (
                    <span
                      key={i}
