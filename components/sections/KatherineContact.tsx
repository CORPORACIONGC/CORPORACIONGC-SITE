...
const contactItems = [
  {
    icon: Envelope,
    label: "Email",
    value: KATHERINE_CONTACT.email,
    href: `mailto:${KATHERINE_CONTACT.email}`,
  },
  {
    icon: Phone,
    label: "Teléfono",
    value: KATHERINE_CONTACT.phone,
    href: `tel:${KATHERINE_CONTACT.phoneRaw}`,
  },
];
          ...
          <div>
            ...
            <AnimatedEntry delay={0.2}>
              <p className="mt-5 text-sm text-cream/55 leading-relaxed max-w-[50ch]">
                Atiendo consultas jurídicas en Derecho Administrativo, Derecho
                Público y materia notarial. Cuénteme su situación y buscaremos
                juntos la mejor estrategia legal.
              </p>
            </AnimatedEntry>
          ...
          <div className="flex items-center">
            <AnimatedEntry delay={0.3} direction="right" className="w-full">
              <div className="p-8 md:p-10 rounded-2xl bg-cream/[0.04] border border-cream/[0.10] backdrop-blur-sm">
                ...
                <MagneticButton
                  href={`https://wa.me/${KATHERINE_CONTACT.phoneRaw}?text=Hola%20Licda.%20Gonz%C3%A1lez%2C%20me%20gustar%C3%ADa%20coordinar%20una%20consulta%20jur%C3%ADdica.`}
                  variant="primary"
