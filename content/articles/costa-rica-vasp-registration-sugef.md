...
faq:
  ...
  - question: "Can a foreign company register as a VASP in Costa Rica?"
    answer: "Yes, through a Costa Rican entity. In practice the project turns on several requirements that are only visible from local practice — how the application is signed and filed, the company's banking relationship, and the coherence of the company's profile before the other Costa Rican authorities, among others. Verifying them at the outset prevents the filing from stalling once the clock is running; that diagnostic is the first phase of any serious project."
  - question: "If my business only accepts cryptocurrency as payment, must it register?"
    answer: "As a rule, accepting virtual assets as payment for your own goods or services is a different situation from providing virtual asset services to third parties as a business, which is what Article 15 quater regulates. The line becomes thin when the merchant habitually converts, holds or transfers customers' assets. Each business model deserves a concrete scope analysis before the obligation is ruled out."
  - question: "Can I buy and sell virtual assets with my own funds before registering?"
    answer: "Article 15 quater reaches anyone performing the activities 'as a business' and 'for itself or for third parties', so operating with proprietary capital alone leaves the question open: where buying and selling virtual assets is habitual and constitutes the company's line of business, the statute covers it even before there is a single customer. Each model deserves a scope opinion before operating."
  - question: "Which services are legally mandatory and which are optional?"
    answer: "Mandatory by statute: registration with SUGEF and the full prevention regime of Article 15 quater. Regulation-dependent, still pending from CONASSIF: the filing platform, the forms, the thresholds and the documentary detail. Optional: a good part of what some offers present as compulsory. A serious quote keeps those three columns apart and gives the legal basis for every line item; demand it before signing."
...
> This article is backed by Corporación GC's ongoing engagements advising local and international virtual asset businesses under the new framework. To assess whether your operation is covered or to prepare your registration, visit our [fintech and crypto regulatory practice](/areas/regulacion-fintech-criptoactivos) or [get in touch](/contacto).
