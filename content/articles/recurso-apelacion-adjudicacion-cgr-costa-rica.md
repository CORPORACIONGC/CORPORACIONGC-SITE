---
title: "Recurso de apelación contra la adjudicación ante la CGR: cómo impugnar una licitación en Costa Rica"
date: "2026-07-02"
...
faq:
  ...
  - question: "¿La apelación detiene la firma del contrato?"
    answer: "Sí. Interpuesto el recurso de apelación opera la suspensión automática de todos los efectos del acto final recurrido (art. 98 de la Ley 9986). La Administración no puede perfeccionar el contrato mientras la Contraloría no resuelva; si el recurso se rechaza en admisibilidad, el acto queda firme."
  - question: "¿Qué es el mejor derecho y por qué me pueden rechazar el recurso por no acreditarlo?"
    answer: "Es la demostración de que usted sería el legítimo adjudicatario si su recurso prospera: que su oferta es elegible y que, aplicado el sistema de evaluación del cartel, usted quedaría en primer lugar. El Reglamento exige incluir en el escrito su propio ejercicio de aplicación del sistema de evaluación (art. 262). Sin esa demostración, el recurso se rechaza de plano por improcedencia manifiesta, sin análisis de fondo."
  - question: "Me rechazaron la oferta por un defecto que era subsanable, ¿puedo apelar?"
    answer: "Sí, ese es uno de los motivos típicos de apelación. La Ley 9986 obliga a permitir la subsanación de los defectos de la oferta (art. 50); si la Administración lo excluyó sin darle esa oportunidad, o rechazó una subsanación procedente, la exclusión puede anularse. Deberá demostrar además que, readmitida su oferta, usted resultaría adjudicatario."
  - question: "¿Qué pasa si la Contraloría rechaza mi apelación?"
    answer: "La resolución de fondo agota la vía administrativa (art. 98). A partir de ahí puede demandarse la nulidad de la adjudicación ante el Tribunal Contencioso Administrativo, con posibilidad de medidas cautelares. Si el contrato ya se ejecutó o está en ejecución, la sentencia favorable se traduce en la indemnización de los daños y perjuicios causados."
  - question: "¿Cuánto dura el trámite de la apelación ante la CGR?"
    answer: "La ley fija una etapa de admisibilidad de ocho días hábiles (con audiencia inicial de ocho días a las partes) y una etapa de fondo de treinta días hábiles desde el vencimiento de la audiencia inicial, prorrogable hasta por diez días adicionales en casos de alta complejidad (art. 97). En la práctica, entre la interposición y la resolución final transcurren alrededor de dos a tres meses."
---
...
> Si acaba de recibir la notificación de una adjudicación que considera ilegal, el plazo ya está corriendo. Nuestra área de [contratación pública](/areas/contratacion-publica) evalúa la viabilidad del recurso —elegibilidad, mejor derecho y prueba— antes de comprometerlo.
...
Si su caso es una licitación **menor**, una **subasta inversa** o una licitación **reducida**, el recurso correcto es la revocatoria — presentarlo como apelación produce el rechazo de plano. Vea la [guía comparativa de los tres recursos](/articulos/recursos-contratacion-publica-objecion-apelacion-revocatoria).
...
- En la [R-DCP-SICOP-00466-2025](https://cgrfiles.cgr.go.cr/publico/docs_cgr/2025/SIGYD_D/SIGYD_D_2025007965.pdf) (18 de marzo de 2025, licitación mayor del MOPT), la CGR **rechazó de plano por improcedencia manifiesta** una apelación por falta de fundamentación: el apelante no rebatió con prueba idónea los estudios técnicos de la Administración. La resolución reitera una línea de más de quince años: la carga de la prueba es del recurrente.
- En la [R-DCP-SICOP-00755-2025](https://cgrfiles.cgr.go.cr/publico/docs_cgr/2025/SIGYD_D/SIGYD_D_2025010700.pdf) (6 de mayo de 2025, licitación mayor del ICE), la CGR declaró **sin lugar** la apelación de un oferente cuyo precio había sido declarado inaceptable: como no justificó su precio en la indagatoria previa al acto final (art. 106 del Reglamento), esa discusión **precluyó** — su oferta siguió siendo inelegible y, sin elegibilidad, no hay legitimación para apelar.
...
| Resultado | Efecto |
|---|---|
| **Rechazo en admisibilidad** | El acto final queda **firme**. El contrato puede perfeccionarse. |
| **Sin lugar (fondo)** | Se confirma la adjudicación, se levanta la suspensión y se **agota la vía administrativa**. |
| **Con lugar o parcialmente con lugar** | **Nulidad** de la adjudicación en lo correspondiente; la Administración debe readjudicar o declarar desierto/infructuoso. Agota la vía administrativa. |
| **Anulación de oficio** | La CGR puede anular el acto o el procedimiento aunque el alegato no lo pidiera, si advierte un vicio de nulidad — previa audiencia a las partes. |

Cuando el recurso está bien construido, el resultado es contundente. En la resolución [R-DCP-SICOP-00211-2025](https://cgrfiles.cgr.go.cr/publico/docs_cgr/2025/SIGYD_D/SIGYD_D_2025002416.pdf) (5 de febrero de 2025), la CGR declaró **con lugar** la apelación de un oferente en una compra de medicamentos de la CCSS y **anuló la adjudicación**: la empresa ganadora ejecutaría la distribución mediante un tercero sin haber declarado la subcontratación en su oferta (arts. 49 y 50 de la Ley), y ese defecto —determinó la Contraloría— no es subsanable en fase recursiva. La oferta adjudicada devino inelegible y el concurso se retrotrajo.
...
📌 **Lea también:** [Objeción, apelación o revocatoria: ¿qué recurso presento en una licitación pública?](/articulos/recursos-contratacion-publica-objecion-apelacion-revocatoria)
