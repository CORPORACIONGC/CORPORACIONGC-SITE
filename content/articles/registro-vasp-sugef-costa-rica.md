...
faq:
  ...
  - question: "¿Una empresa extranjera puede registrarse como VASP en Costa Rica?"
    answer: "Sí, mediante una sociedad costarricense. El proyecto exige resolver varios requisitos que solo se ven desde la práctica local —la representación con firma digital costarricense, la relación bancaria y la coherencia del perfil de la sociedad ante las autoridades locales, entre otros—, y conviene verificarlos al inicio, porque descubiertos tarde traban el trámite cuando ya corre el plazo. Ese diagnóstico es la primera fase de cualquier proyecto serio."
  - question: "¿Si mi empresa solo acepta criptomonedas como medio de pago, debe inscribirse?"
    answer: "En principio, aceptar activos virtuales como pago por bienes o servicios propios difiere de prestar servicios de activos virtuales para terceros como negocio, que es lo que el artículo 15 quater regula. La frontera se vuelve delgada cuando el comercio convierte, custodia o transfiere activos de sus clientes de forma habitual. Cada modelo de negocio merece un análisis de sujeción concreto antes de descartarse."
  - question: "¿Puedo comprar y vender activos virtuales con fondos propios antes de inscribirme?"
    answer: "El artículo 15 quater alcanza a quien realice las actividades «como negocio» y «para sí o para terceros», de modo que operar únicamente con capital propio deja abierta la sujeción: si la compra y venta de activos virtuales es habitual y constituye el giro de la sociedad, la norma la cubre aunque todavía no existan clientes. Cada modelo merece un dictamen de sujeción antes de operar."
  - question: "¿Qué servicios son obligatorios por ley y cuáles opcionales?"
    answer: "Obligatorio por ley: la inscripción ante SUGEF y el régimen completo de prevención del artículo 15 quater. Dependiente del reglamento del CONASSIF, todavía pendiente: la plataforma, los formularios, los umbrales y el detalle documental. Opcional: buena parte de lo que algunas ofertas presentan como forzoso. Una cotización seria separa esas tres columnas y da el fundamento normativo de cada rubro; exíjalo antes de firmar."
