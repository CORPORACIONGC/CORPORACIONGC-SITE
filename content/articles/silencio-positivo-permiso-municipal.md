---
title: "Silencio positivo: cómo obtener el permiso municipal cuando la municipalidad no responde"
date: "2026-06-13"
...
seoTitle: "Silencio Positivo: Permiso Municipal si No le Responden"
seoDescription: "¿La municipalidad no resolvió su permiso de construcción a tiempo? El silencio positivo puede darlo por aprobado: vea el procedimiento y sus límites."
faq:
  - question: "¿Qué es el silencio positivo en un permiso municipal?"
    answer: "Es la figura por la cual, vencido el plazo que tiene la municipalidad para resolver una solicitud de permiso, licencia o autorización sin que se haya pronunciado, la solicitud se tiene por aprobada. Su base está en los artículos 330 y 331 de la Ley General de la Administración Pública y en el artículo 7 de la Ley 8220. El artículo 7 vigente dispone que 'procederá el silencio positivo de pleno derecho y se tendrán por aprobadas tales solicitudes, siempre y cuando se cumpla con los requisitos legalmente establecidos'."
  - question: "¿En cuánto tiempo opera el silencio positivo?"
    answer: "El artículo 331 de la Ley General de la Administración Pública fija un plazo de un mes, contado a partir de que el órgano reciba la solicitud 'con los requisitos legales' —es decir, completa—. Si una norma especial fija un plazo distinto de resolución, se aplica ese. El punto clave es que el plazo solo empieza a correr cuando la solicitud está completa: si falta un requisito, el plazo no avanza."
  - question: "¿Cómo hago valer el silencio positivo ante la municipalidad?"
    answer: "Conforme al artículo 7 de la Ley 8220, basta presentar una declaración jurada —rendida ante notario público, firmada ante el funcionario, o por documento electrónico con firma digital— en la que se haga constar que se cumplieron todos los requisitos y que la municipalidad no resolvió en plazo. La municipalidad tiene entonces dos días hábiles para emitir la resolución o el acto confirmatorio del permiso; el silencio positivo opera de pleno derecho y ninguna institución puede desconocerlo."
  - question: "¿El silencio positivo sirve para cualquier permiso de construcción?"
    answer: "No. El propio artículo 7 de la Ley 8220 exceptúa expresamente las licencias, los permisos y las autorizaciones en materia de salud pública y ambiente, y aquellas que por disposición constitucional, legal o jurisprudencial no procedan. Además, la Ley Forestal (artículo 4) excluye el silencio positivo en materia de recursos naturales, y la Sala Constitucional ha sostenido reiteradamente que en materia ambiental el silencio positivo no opera de pleno derecho."
  - question: "¿Puedo obtener por silencio positivo un permiso para algo que la ley no permite?"
    answer: "No. El silencio positivo exige que la solicitud reúna los requisitos legales (artículo 331 de la Ley General de la Administración Pública y artículo 7 de la Ley 8220). No se adquiere por silencio lo que es contrario al ordenamiento: la Sala Primera ha señalado que el silencio positivo es excepcional y solo procede donde una norma de rango legal lo reconoce, y la Procuraduría ha dictaminado que tampoco opera sobre bienes de dominio público sujetos a régimen especial."
  - question: "¿Necesito la licencia municipal para construir?"
    answer: "Sí. El artículo 74 de la Ley de Construcciones dispone que 'toda obra relacionada con la construcción, que se ejecute en las poblaciones de la República, sea de carácter permanente o provisional, deberá ejecutarse con licencia de la Municipalidad correspondiente'. Y el artículo 57 de la Ley de Planificación Urbana prohíbe construir contra lo prescrito en la ley, los reglamentos y el respectivo permiso municipal."
  - question: "¿Qué hago si la municipalidad desconoce el silencio positivo ya operado?"
    answer: "El silencio positivo opera de pleno derecho y, una vez acaecido, la municipalidad no puede dictar un acto denegatorio (artículo 331 de la Ley General de la Administración Pública). Para revertirlo, la Administración debe acudir al procedimiento de nulidad del artículo 173 de esa ley o a un proceso de lesividad. Si hay discrepancia sobre si el silencio operó, la Sala Constitucional ha dicho que es 'un problema de legalidad y no de constitucionalidad', que se ventila ante la jurisdicción contencioso-administrativa."
---
...
Pero conviene decirlo desde el principio, porque aquí se cometen los errores más caros: el silencio positivo **no es automático ni universal**. Opera solo si la solicitud reunía todos los requisitos legales, y la propia ley y la Sala Constitucional lo excluyen en materias enteras —el ambiente, la salud pública, los bienes de dominio público—. Esta guía explica, con base en el texto vigente de la [Ley General de la Administración Pública](https://pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?nValor1=1&nValor2=13231) (Ley N.° 6227) y la [Ley de Protección al Ciudadano del Exceso de Requisitos y Trámites Administrativos](https://pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?nValor1=1&nValor2=48116) (Ley N.° 8220), cómo funciona el silencio positivo, cómo se hace valer y dónde están sus límites.

---

## La licencia municipal de construcción es obligatoria

Antes del silencio hay que entender por qué se necesita el permiso. El artículo 74 de la [Ley de Construcciones](https://pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?nValor1=1&nValor2=36307) (Ley N.° 833) es categórico: *"Toda obra relacionada con la construcción, que se ejecute en las poblaciones de la República, sea de carácter permanente o provisional, deberá ejecutarse con licencia de la Municipalidad correspondiente."* En el mismo sentido, el artículo 57 de la [Ley de Planificación Urbana](https://pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?nValor1=1&nValor2=35669) (Ley N.° 4240) dispone que *"está prohibido realizar obras de construcción contra lo prescrito en la ley, los reglamentos y el respectivo permiso municipal."*

La Sala Constitucional ha aplicado esta regla sin matices: en la [sentencia N.° 2004-13142, de 23 de noviembre de 2004](https://vlex.co.cr/vid/498746438), confirmó la potestad municipal de multar una obra ejecutada sin licencia previa, recordando, con cita del artículo 74, que toda construcción debe contar con la licencia de la municipalidad correspondiente. Construir sin permiso expone a sanciones, clausura y orden de demolición. De ahí la importancia de obtener el permiso —y de saber qué hacer cuando la municipalidad simplemente no responde—.
...
| El silencio positivo NO opera | Fundamento |
|---|---|
| Si la solicitud estaba incompleta o no reunía los requisitos legales | Art. 331 de la Ley N.° 6227 ("con los requisitos legales"); art. 7 de la Ley N.° 8220 |
...
| En materia ambiental y de recursos naturales | Art. 7 de la Ley N.° 8220; art. 4 de la Ley Forestal N.° 7575; jurisprudencia de la Sala Constitucional |
| En materia de salud pública | Art. 7 de la Ley N.° 8220 |
| Sobre bienes de dominio público sujetos a régimen especial | Dictamen PGR C-198-2002 |
