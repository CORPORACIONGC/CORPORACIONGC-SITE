---
title: "Me llegó un traslado de cargos: qué significa, plazos y qué hacer"
date: "2026-07-03"
...
faq:
  - question: "¿Qué es un traslado de cargos?"
    answer: "Es el acto con que la Administración Pública le comunica formalmente los hechos que se le atribuyen, las normas presuntamente infringidas y las posibles consecuencias, dando inicio al procedimiento administrativo que puede terminar en una sanción. Es la aplicación del principio de intimación: nadie puede ser sancionado sin conocer antes, con precisión, de qué debe defenderse."
  - question: "¿Qué plazo tengo para responder un traslado de cargos?"
    answer: "Depende del régimen. En el procedimiento ordinario de la LGAP, la citación a la comparecencia oral debe hacerse con al menos quince días de anticipación (artículo 311), y la prueba se presenta antes o durante la comparecencia (artículo 312). En el procedimiento de despido de la Ley Marco de Empleo Público, el servidor tiene quince días para presentar sus descargos (artículo 21 de la Ley 10159). El propio traslado debe indicar el plazo aplicable: verificarlo es lo primero."
  - question: "¿Qué debe contener un traslado de cargos para ser válido?"
    answer: "Una relación precisa y circunstanciada de los hechos que se le atribuyen —con indicación de tiempo, modo y lugar—, las normas presuntamente infringidas, las posibles consecuencias o sanciones, el órgano que instruye y los recursos disponibles. La jurisprudencia constitucional exige que la imputación permita ejercer la defensa; un traslado con cargos vagos o genéricos lesiona el debido proceso y puede viciar todo el procedimiento."
  - question: "¿Qué pasa si ignoro el traslado de cargos?"
    answer: "El procedimiento continúa sin usted. Su silencio no equivale a aceptar los hechos (artículo 315 de la LGAP), pero pierde la oportunidad de ofrecer prueba, interrogar testigos y alegar — y esas facultades caducan si no se ejercen en la comparecencia (artículo 317). En la práctica, ignorar el traslado entrega el expediente a la versión de la Administración."
  - question: "¿Debo contestar el traslado de cargos de inmediato?"
    answer: "La urgencia real está en actuar, y actuar empieza por leer el expediente y evaluar el caso con criterio técnico, dentro del plazo. Contestar de inmediato y sin análisis es uno de los errores más comunes: se admiten hechos, se aporta información que la Administración no tenía o se renuncia sin saberlo a defensas de forma y de fondo. La respuesta se construye después de conocer el expediente completo, que usted tiene derecho a examinar y copiar (artículo 272 de la LGAP)."
  - question: "¿Puedo pedir el expediente administrativo desde ya?"
    answer: "Sí. Desde la notificación del traslado usted, sus representantes y cualquier abogado tienen derecho a examinar, leer y copiar cualquier pieza del expediente, en cualquier fase del procedimiento (artículo 272 de la LGAP). El traslado debe indicarle dónde consultarlo (artículo 312). Si le niegan el acceso sin motivación válida, esa denegatoria es recurrible y configura indefensión."
  - question: "¿El traslado de cargos se puede impugnar?"
    answer: "Sí. En el procedimiento ordinario, el acto que inicia el procedimiento es de los pocos actos de trámite contra los que caben los recursos ordinarios (artículo 345 de la LGAP), y el plazo es de veinticuatro horas desde su comunicación (artículo 346). Además, sus defectos —imputación imprecisa, órgano incompetente, plazo menor al legal— pueden alegarse como vicios de nulidad durante el procedimiento y al impugnar la sanción final."
  - question: "¿Un traslado de cargos significa que ya me van a sancionar?"
    answer: "Significa que la Administración considera que existen elementos para investigarlo con miras a una posible sanción. El propósito legal del procedimiento es verificar la verdad real de los hechos (artículos 214 y 221 de la LGAP), y buena parte de los procedimientos termina sin sanción o con una sanción menor cuando la defensa demuestra que los hechos no ocurrieron, no son sancionables o el trámite está viciado."
---
...
Con esos frentes asegurados, la defensa de fondo —qué prueba ofrecer, qué nulidades alegar, si conviene recurrir el acto de apertura, cómo encarar la comparecencia— se diseña caso por caso. Ese diseño es exactamente el trabajo que hacemos al [evaluar un procedimiento](/areas/procedimientos-sancionatorios) en sus etapas iniciales.
...
1. **Contestar de inmediato, por escrito y sin asesoría**, admitiendo hechos o entregando información que la Administración no tenía. Es el error más frecuente y el más costoso.
2. **Dejar pasar los quince días sin pedir el expediente**, y descubrir en la comparecencia qué prueba existía en su contra.
3. **Asumir que el plazo indicado en el traslado es correcto** sin verificarlo contra la ley del régimen aplicable.
4. **Guardar el documento "para después"** hasta que la comparecencia está encima y ya no hay tiempo de construir prueba.
5. **Tratar el procedimiento como un malentendido** que se aclara con una conversación informal, mientras el expediente formal crece en un solo sentido.
...
Cuando el traslado de cargos amenaza un puesto en el sector público —ministerios, municipalidades, instituciones autónomas, CCSS—, al procedimiento se suman el artículo 21 de la Ley Marco de Empleo Público (Ley N.° 10159), que regula el procedimiento especial de despido con su traslado por quince días, y las garantías de estabilidad del artículo 192 constitucional. La vía de impugnación posterior también cambia según la institución y el régimen. Vea nuestra área de [empleo público](/areas/empleo-publico), dedicada a la defensa del servidor.
