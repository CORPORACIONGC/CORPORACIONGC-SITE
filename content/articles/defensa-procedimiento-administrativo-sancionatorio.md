---
title: "Me abrieron un procedimiento administrativo sancionatorio: ¿cómo defenderse?"
date: "2026-07-03"
...
faq:
  - question: "¿Qué es un procedimiento administrativo sancionatorio?"
    answer: "Es el trámite formal que la Administración Pública debe seguir, conforme a la Ley General de la Administración Pública, antes de imponer una sanción: una multa, la suspensión o cancelación de un permiso, una clausura o, en materia disciplinaria, la suspensión o destitución de un servidor. Su eje es una comparecencia oral y privada donde se recibe la prueba, y su omisión o tramitación defectuosa puede anular la sanción."
  - question: "¿Es obligatorio que la Administración siga el procedimiento ordinario antes de sancionarme?"
    answer: "Sí, cuando el acto final puede causarle un perjuicio grave —imponerle obligaciones, suprimirle o denegarle derechos— o cuando el procedimiento disciplinario puede terminar en suspensión, destitución o una sanción de similar gravedad (artículo 308 de la LGAP). Si la Administración usó un trámite abreviado donde correspondía el ordinario, esa escogencia es un vicio que puede invalidar la sanción."
  - question: "¿Cuánto tiempo tengo para preparar mi defensa antes de la comparecencia?"
    answer: "La citación a la comparecencia oral debe hacerse con quince días de anticipación (artículo 311 de la LGAP). En ese lapso usted tiene derecho a examinar y copiar el expediente completo y debe presentar su prueba antes o durante la propia comparecencia (artículo 312). Es el período decisivo del procedimiento: la defensa que no se construye ahí difícilmente se rescata después."
  - question: "¿Necesito abogado para un procedimiento administrativo sancionatorio?"
    answer: "La ley no lo exige en todos los casos, pero la comparecencia oral funciona como un juicio: se interrogan testigos y peritos, se objeta prueba y se formulan conclusiones de hecho y de derecho, todo verbalmente y bajo sanción de caducidad si se omite (artículo 317 de la LGAP). Los vicios que anulan una sanción son técnicos y suelen pasar inadvertidos para quien no litiga esta materia. Lo que está en juego —el empleo, un permiso, una multa, la reputación— casi siempre supera con creces el costo de la defensa."
  - question: "¿Qué pasa si no asisto a la comparecencia oral?"
    answer: "La comparecencia se realiza de todos modos, aunque su ausencia injustificada no vale como aceptación de los hechos ni de las pruebas de la Administración (artículo 315 de la LGAP). Aun así, quien no comparece pierde la oportunidad de ofrecer prueba, repreguntar a los testigos y formular conclusiones, que son las herramientas centrales de la defensa."
  - question: "¿Puedo ver el expediente que la Administración tiene en mi contra?"
    answer: "Sí. Las partes, sus representantes y cualquier abogado tienen derecho, en cualquier fase del procedimiento, a examinar, leer y copiar cualquier pieza del expediente y a pedir certificaciones (artículo 272 de la LGAP). La denegatoria de acceso debe estar motivada y es recurrible. Negarle el expediente de forma injustificada configura indefensión."
  - question: "¿Cuánto puede durar el procedimiento administrativo en mi contra?"
    answer: "La LGAP ordena concluirlo por acto final dentro de los dos meses posteriores a su inicio (artículo 261). Además, si el procedimiento se paraliza por más de seis meses por causa imputable a la Administración que lo inició de oficio, se produce la caducidad y debe ordenarse su archivo (artículo 340). La duración real suele ser mayor, y precisamente esas demoras pueden convertirse en una defensa."
  - question: "¿Qué recursos puedo presentar contra la sanción?"
    answer: "Contra el acto final caben los recursos ordinarios de revocatoria y apelación, que deben interponerse en el plazo de tres días contados desde la última comunicación del acto (artículos 343, 345 y 346 de la LGAP). La apelación la resuelve el superior, que agota la vía administrativa. Además, el agotamiento de esa vía es facultativo: usted puede acudir directamente al Tribunal Contencioso Administrativo (artículo 31 del CPCA)."
  - question: "¿Se puede suspender la sanción mientras se discute su validez?"
    answer: "Sí. En la vía contencioso-administrativa puede solicitarse una medida cautelar —incluso antes de presentar la demanda— para suspender los efectos de la sanción mientras el tribunal decide sobre su validez (artículos 19 a 30 del CPCA). Es la herramienta que evita que una multa, una clausura o una destitución se ejecuten antes de que un juez examine si la sanción es válida."
---
...
La lectura técnica de ese documento es el primer acto de la defensa. De su contenido depende qué prueba conviene ofrecer, qué vicios existen desde el origen y si el órgano que instruye es competente. Dedicamos una guía completa a ese momento: [me llegó un traslado de cargos: qué significa y qué hacer](/articulos/traslado-de-cargos-que-hacer-costa-rica).
...
Si le notificaron la apertura de un procedimiento, una citación a comparecencia o un acto final sancionatorio, [contáctenos](/#contacto). La evaluación temprana del expediente permite saber, antes de que los plazos venzan, qué tan sólido es el caso en su contra y qué defensas están disponibles.
